...
const feature = [
  {
    ...
    points: [
      "Upload employee census data (age, gender, designation, salary) to auto-calculate premiums.", 
      "Configure benefit options, sub-limits, and variants (e.g., maternity cover, OPD, PED inclusion).", 
      "Choose preferred network tiers (Basic, Enhanced, Premium) and instantly see pricing differences.",
      "Generate multiple quote variations for comparison.",
    ],
  },
  {
    title: "Product & Benefit Configuration",
    icon: <FaBuilding className="text-green-600 text-4xl mb-4" />,
    points: [
      "Define new products per insurer, region, or corporate size.", 
      "Configure benefit sub-limits (room rent, maternity, ICU, ambulance, etc.).", 
      "Create variants and optional add-ons tailored to SME needs.",
      "Flexible mapping of insurance company + network provider combinations.",
    ],
  },
  {
    title: "Broker Access Portal",
    icon: <FaUsers className="text-blue-600 text-4xl mb-4" />,
    points: [
      "Brokers register and access the platform securely.",
      "Role-based rights to configure and generate quotes.", 
      "Generate proposal-ready PDFs with insurer branding.",
      "Track all quotes, revisions, and approvals in a single dashboard.",
    ],
  },
  {
    title: "Comparative Quote Management",
    icon: <FaFileMedical className="text-red-600 text-4xl mb-4" />,
    points: [
      "Compare multiple insurer quotes side-by-side (premium, benefits, exclusions).", 
      "Highlight differences in coverage limits, waiting periods, and network hospitals.",
      "Share proposals directly with corporates via email or digital link.",
    ],
  },
  {
    ...
    points: [
      "Ensure DHA and CBUAE regulatory alignment for all configured products.",
      "Maintain an audit trail for product setup, broker access, and quote generation.",
      "Generate MIS reports for quote history, insurer performance, and conversion ratios.",
    ],
  },
];
const QuoteMasterComp = () => {
        ...
        >
          <div className="row py-5">
            <div className="col-12 pt-lg-5 mt-lg-5 text-center">
              <h1 className="display-4 text-white animated zoomIn">QuoteMaster360</h1>
        ...
        <div className="container py-5">
          <div className="row align-items-center g-5">
            <div className="col-lg-5 wow zoomIn" data-wow-delay="0.8s">
              ...
              >
                <img
                  src={`${base_url}/assets/img/Products/ZOYAME-Driving Growth with Custom Mobile Applications-IM001.jpg`}
                  alt="About Us"
                  className="img-fluid"
                  style={{
                    width: '100%',
            ...
            <div className="col-lg-7">
              <div className="section-title position-relative pb-3 mb-4 wow slideInLeft" data-wow-delay="0.2s">
                <h5 className="fw-bold text-uppercase text-primary" style={{ color: '#65518c' }}>
                  QuoteMaster360 Platform 
                </h5>
                <h1 className="display-5 mb-0">Smart, Seamless, and Scalable Quotation Management</h1>
              </div>

              <p className="mb-3 text-muted wow fadeInUp" data-wow-delay="0.3s">
                QuoteMaster360 is a smart insurance quotation platform designed for the UAE’s SME corporate segment. It transforms the traditionally manual process of generating group health and employee benefit quotes into a fully automated, data-driven workflow.</p>
              <p className="mb-4 text-muted wow fadeInUp" data-wow-delay="0.4s">
                By leveraging employee census data, the system dynamically calculates premiums based on benefit selections, coverage variants, sub-limits, and network choices. This ensures corporates receive accurate, transparent, and customized insurance proposals in just minutes.
              </p>
              <p className="mb-4 text-muted wow fadeInUp" data-wow-delay="0.4s">
                Built with modular product configuration, insurers and brokers can set up new products by region, provider networks, and benefit structures. With role-based access, brokers can log in, configure benefits, and generate multi-option quotes instantly — all while remaining compliant with Dubai Health Authority (DHA) and Central Bank of UAE (CBUAE) guidelines.
              </p>
              <p className="mb-4 text-muted wow fadeInUp" data-wow-delay="0.4s">
                The result: faster sales cycles, smarter pricing, and greater customer satisfaction in the competitive SME insurance market.              
              </p>
            </div>
        ...
        <div className="container py-5">
          ...
          <div className="row g-4">
            ...
            {feature.slice(0, 3).map((feature, index) => {
              let gradient =
                feature.title.includes("Automated Quotation Engine")
                  ? "linear-gradient(135deg,#6C5DD3,#9F7AEA)"
                  : feature.title.includes("Product & Benefit Configuration")
        ...
        <div className="container py-5">
          ...
          <div className="row align-items-center mb-5">
            <div className="col-lg-7 mb-4 mb-lg-0">
              <img
                src={`${base_url}/assets/img/Screenshots/quote-01.png`}
                alt="Product List"
                ...
                onClick={() =>
                  handleShow(`${base_url}/assets/img/Screenshots/quote-01.png`, "Product List")
                }
              />
            </div>
            <div className="col-lg-5">
              <h2 className="fw-bold mb-3">Product List</h2>
              {/* <p
          ...
          <div className="row align-items-center mb-5">
            ...
            <div className="col-lg-7">
              <img
                src={`${base_url}/assets/img/Screenshots/quote-02.jpg`}
                alt="Add Product"
                className="img-fluid rounded shadow"
                style={{
                  width: "100%",
                ...
                onClick={() =>
                  handleShow(`${base_url}/assets/img/Screenshots/quote-02.jpg`, "Add Product")
                }
              />
            </div>
          </div>
          ...
          <div className="row align-items-center mb-5">
            <div className="col-lg-7 mb-4 mb-lg-0">
              <img
                src={`${base_url}/assets/img/Screenshots/quote-03.jpg`}
                alt="Edit Product"
                className="img-fluid rounded shadow"
                style={{
                  width: "100%",
                ...
                onClick={() =>
                  handleShow(`${base_url}/assets/img/Screenshots/quote-03.jpg`, "Edit Product")
                }
              />
            </div>
            <div className="col-lg-5">
          ...
          <div className="row align-items-center mb-5 mt-4">
            ...
            <div className="col-lg-7 mt-4">
              <img
                src={`${base_url}/assets/img/Screenshots/quote-04.png`}
                alt="Login Page"
                className="img-fluid rounded shadow"
                style={{
                  width: "100%",
                ...
                onClick={() =>
                  handleShow(`${base_url}/assets/img/Screenshots/quote-04.png`, "Login Page")
                }
              />
            </div>
          </div>
...
export default QuoteMasterComp