...
import {FaMapMarkerAlt,FaPhoneAlt,FaEnvelope,FaFacebookF,FaTwitter,FaInstagram,FaLinkedinIn,FaDonate,FaBars,FaSearch,} from 'react-icons/fa';
...
const Navbar = () => {
  ...
  return (
      <>
      {/* Topbar Start */}
      <div className="container-fluid  px-5 d-none d-lg-block" style={{ backgroundColor: '#537ed2' }}>
